...
knitr::opts_chunk$set(echo = TRUE, cache = TRUE, 
                      fig.path = "Figures_20160722/Fig-silva/", 
...
```{r plot-fp-fn-boxplot, fig.width=8, fig.height=7, warning=FALSE, message = FALSE}
...
```{r plot-fp-fn-boxplot-no-mothur, fig.width=8, fig.height=7, warning=FALSE, message = FALSE}
